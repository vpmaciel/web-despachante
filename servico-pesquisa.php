...
echo open_tr . open_th . 'servico'  . close_th . close_tr; 

$registro['servico_data'] = isset($registro['servico_data']) ? $registro['servico_data'] : '';
...
$registro['servico_placa_veiculo'] = isset($registro['servico_placa_veiculo']) ? $registro['servico_placa_veiculo'] : '';
...
$registro['servico_valor'] = isset($registro['servico_valor']) ? $registro['servico_valor'] : '';
...
$registro['servico_descricao'] = isset($registro['servico_descricao']) ? $registro['servico_descricao'] : '';
...
$registro['servico_cpf_cnpj_cliente'] = isset($registro['servico_cpf_cnpj_cliente']) ? $registro['servico_cpf_cnpj_cliente'] : '';
...
$registro['servico_nome_cliente'] = isset($registro['servico_nome_cliente']) ? $registro['servico_nome_cliente'] : '';
...
$registro['servico_telefone_cliente'] = isset($registro['servico_telefone_cliente']) ? $registro['servico_telefone_cliente'] : '';
