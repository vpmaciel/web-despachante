...
echo '<script src="cliente_cadastro.ts"></script>';
...
$LINK = '<a href="cliente_pesquisa.php">Clique aqui para pesquisar</a>';
...
$INPUT = '<input type="text" id="CLIENTE_NOME" name="CLIENTE_NOME" minlength="5" maxlength="100" value="' . $cliente['CLIENTE_NOME'] .'">';
...
$INPUT = '<input type="text" id="CLIENTE_TELEFONE" name="CLIENTE_TELEFONE" onkeypress="mask(this, mphone);" value="' . $cliente['CLIENTE_TELEFONE'] .'">';
echo TR_OPEN . TD_OPEN. $INPUT . TD_CLOSE . TR_CLOSE;
